...
async function extractLinks(page: Page, startDomain: string, sameDomainOnly: boolean): Promise<string[]> {
  ...
  for (const href of links) {
    try {
      ...
      if (path.match(/\.(pdf|jpg|jpeg|png|gif|svg|css|js|ico|woff|woff2|ttf|eot)$/)) continue;
