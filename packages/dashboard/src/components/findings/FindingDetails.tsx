...
// Fix difficulty based on severity
const FIX_DIFFICULTY: Record<Severity, { label: string; time: string; color: string }> = {
    ...
    >
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: 24 }}>
        ...
        <Section title="VISUAL LOCATION">
          ...
          >
            <span style={{ fontSize: 24, color: '#94a3b8' }}>🖼️</span>
...
function AISuggestion({ rank, type, color, text }: AISuggestionProps) {
  const medals = ['🥇', '🥈', '🥉', '🏅', '🏅'];
...
// ==============================================
// Drawer Wrapper with Backdrop
// ==============================================

interface FindingDetailsDrawerProps extends FindingDetailsProps {
  isOpen: boolean;
}
...
// Also export the standalone FindingDetails for flexibility
export { FindingDetails };