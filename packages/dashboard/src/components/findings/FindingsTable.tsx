...
export function FindingsTable({ findings, pageUrl, onViewDetails, onFalsePositiveChange }: FindingsTableProps) {
  // Pagination
            ...
            <tbody>
              {paginated.map(finding => (
                <FindingsRow
                  ...
                  onToggleFalsePositive={() => handleToggleFalsePositive(finding)}
